...
from TextIngester import execute_pipeline    # main pipeline process
...
required_params = ['input_file_path', 'target_table', 'error_file_path', 'connection_name', 'processed_file_path', 'input_file_name']
...
args['delimiter_regex'] = get_optional_arg('delimiter_regex')
args['expected_columns'] = get_optional_arg('expected_columns')
args['filter_record_type'] = get_optional_arg('filter_record_type')
args['col_label'] = get_optional_arg('col_label')
